...
import { Calendar, MapPin, Users, Trophy, ExternalLink, Camera, Download, Coffee, Medal, Info, ChevronRight, Heart, Sparkles, Ticket, Gamepad2, Gift, Flame } from 'lucide-react';

// ==========================================
// DONNÉES DE DÉMONSTRATION - SAINT-VALENTIN
// ==========================================
const galleryImages = [
...
const palmares2025 = [
  { serie: "Série 1", dx: "Gagnants 1 (Club)" },
  { serie: "Série 2", dx: "Gagnants 2 (Club)" },
];
...
export default function SaintValentinPage() {
  ...
  return (
    ...
    <div className="bg-white dark:bg-[#040817] min-h-screen font-['Montserrat'] text-[#081031] dark:text-white transition-colors duration-300 pb-20">
      ...
      {/* =========================================================
          SECTION 1 : HERO (INSPIRÉ DE L'AFFICHE VIOLET/ROSE)
          ========================================================= */}
      <section className="relative w-full h-[80svh] min-h-[600px] flex flex-col justify-center items-center text-center overflow-hidden bg-[#081031]">
        ...
        {/* Halos Lumineux Violet & Rose */}
        <div className="absolute top-1/2 left-[30%] -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#9333EA] rounded-full blur-[150px] opacity-40 pointer-events-none z-0"></div>
        <div className="absolute top-1/2 right-[30%] translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-[#EC4899] rounded-full blur-[150px] opacity-30 pointer-events-none z-0"></div>

        <div className="relative z-20 px-6 max-w-5xl mx-auto mt-20 flex flex-col items-center">
          
          {/* Icône du tournoi */}
          <div className="w-24 h-24 md:w-32 md:h-32 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full flex items-center justify-center p-4 mb-8 shadow-[0_0_30px_rgba(147,51,234,0.4)]">
            <Heart size={48} className="text-[#EC4899] drop-shadow-lg" fill="#EC4899" />
          </div>

          <div className="inline-flex items-center gap-2 px-5 py-2 bg-[#9333EA]/20 border border-[#9333EA]/50 text-white rounded-full font-[900] uppercase text-xs tracking-widest italic mb-6 shadow-lg backdrop-blur-md">
            Tournoi 100% Mixte
          </div>
          ...
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <span className="text-lg md:text-2xl font-bold italic uppercase tracking-[0.3em] text-transparent bg-clip-text bg-gradient-to-r from-[#9333EA] to-[#EC4899]">
              3ème Promobad USC
            </span>
          </div>

          <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-sm md:text-base font-bold text-slate-300 mb-10">
            <span className="flex items-center gap-2"><Calendar size={18} className="text-[#EC4899]" /> Ven. 13 Février 2026</span>
            <span className="flex items-center gap-2"><MapPin size={18} className="text-[#EC4899]" /> STAPS Créteil</span>
            <span className="flex items-center gap-2"><Users size={18} className="text-[#EC4899]" /> Double Mixte (NC-D9)</span>
          </div>

          {/* Bouton d'inscription géant + Badge d'urgence */}
          <div className="relative">
            <div className="absolute -top-4 -right-4 md:-right-8 bg-[#EC4899] text-white px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-xl border-2 border-[#081031] z-30 animate-bounce flex items-center gap-1">
              <Flame size={12} fill="currentColor" /> Plus que 16 places !
            </div>
            <a 
              href="https://badnet.fr" 
              target="_blank" 
              rel="noopener noreferrer"
              className="group relative inline-flex items-center justify-center gap-3 px-10 py-5 bg-gradient-to-r from-[#9333EA] to-[#EC4899] text-white rounded-full font-[900] uppercase italic text-sm md:text-base tracking-widest overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(147,51,234,0.5)]"
            >
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <div className="flex overflow-x-auto hide-scrollbar">
            {[
              ...
              { id: 'activites', label: 'Activités & Jeux', icon: <Sparkles size={16} /> },
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-16 min-h-[500px]">
        ...
        {activeTab === 'infos' && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8 md:space-y-12">
            ...
            <div className="bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-8 md:p-12 border border-slate-200 dark:border-white/5 relative overflow-hidden group shadow-sm transition-colors">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[500px] h-[300px] bg-[#9333EA] rounded-full blur-[100px] opacity-10 group-hover:opacity-20 transition-opacity pointer-events-none"></div>
              
              <div className="relative z-10 max-w-4xl">
                <h3 className="text-2xl md:text-3xl font-[900] uppercase italic text-[#081031] dark:text-white mb-6 leading-normal pt-2">
                    Aux couleurs de <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#9333EA] to-[#EC4899] inline-block py-1">l'Amour</span>
                </h3>
                <div className="space-y-4 text-sm md:text-base font-medium text-slate-600 dark:text-slate-300 leading-relaxed">
                  <p>
                    Mesdames et messieurs, préparez vos raquettes et vos plus belles tenues aux couleurs de l’amour ! L’US Créteil Badminton vous invite à un tournoi <strong>100% mixte, festif et convivial</strong>.
                  </p>
                  <p>
                    Inscrivez-vous vite et venez partager un moment sportif et chaleureux entre passionnées de badminton. On vous attend nombreux pour célébrer l’amour du jeu et des échanges sur les terrains !
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-8 md:p-10 border border-slate-200 dark:border-white/5 relative overflow-hidden group h-full shadow-sm transition-colors">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#9333EA] rounded-full blur-[80px] opacity-10 group-hover:opacity-20 transition-opacity pointer-events-none"></div>
                <h3 className="text-2xl font-[900] uppercase italic text-[#081031] dark:text-white mb-6 flex items-center gap-3 relative z-10">
                  <Medal className="text-[#9333EA]" /> Les Tableaux
                </h3>
                <p className="text-slate-500 dark:text-slate-400 font-medium mb-6 leading-relaxed relative z-10">
                  La compétition (Promobad) est ouverte aux joueuses et joueurs classés de <strong className="text-[#081031] dark:text-white">NC à D9</strong>. Frais de participation : <strong>8 €</strong>.
                </p>
                <div className="flex flex-wrap gap-3 relative z-10">
                  <span className="bg-white dark:bg-black/50 border border-slate-200 dark:border-white/10 px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-wider text-slate-600 dark:text-slate-300 shadow-sm">
                    Double Mixte Uniquement
                  </span>
                </div>
              </div>
              ...
              <div className="bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-8 md:p-10 border border-slate-200 dark:border-white/5 relative overflow-hidden group h-full shadow-sm transition-colors">
                ...
                <ul className="space-y-4 relative z-10">
                  <li className="flex gap-4 items-start">
                    <div className="w-12 h-12 bg-[#9333EA]/10 text-[#9333EA] rounded-xl flex items-center justify-center font-black text-xl shrink-0">VE</div>
                    <div>
                      <h4 className="font-bold text-[#081031] dark:text-white uppercase tracking-wider">Vendredi 13 Février 2026</h4>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Le tournoi se déroulera en soirée, de <strong>18h30 à 23h00</strong>. Plus que quelques places disponibles, foncez !</p>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-4 pr-8 border border-slate-200 dark:border-white/5 shadow-sm transition-colors">
              ...
              <div className="w-full md:w-2/3 py-4">
                ...
                <p className="text-[#9333EA] font-bold mb-4">Avenue Magellan, 94000 Créteil</p>
        ...
        {/* =========================================================
            ONGLET 2 : ACTIVITÉS & JEUX
            ========================================================= */}
        {activeTab === 'activites' && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8">
            
            {/* Bannière Dress Code */}
            <div className="bg-gradient-to-r from-[#9333EA] to-[#EC4899] rounded-[2rem] p-8 text-center text-white shadow-lg relative overflow-hidden">
              <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10 mix-blend-overlay"></div>
              <h3 className="text-2xl md:text-4xl font-[900] uppercase italic mb-2 relative z-10">Dress Code : Rouge & Rose !</h3>
              <p className="font-bold max-w-2xl mx-auto relative z-10">
                Jouez le jeu à fond et portez vos plus belles tenues aux couleurs de l'amour et de la Saint-Valentin pour enflammer les terrains.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <ActivityCard 
                ...
                title="Stands de jeu" 
                desc="Des mini-jeux pour s’amuser et se challenger entre vos matchs. Défiez vos adversaires !"
                color="text-[#9333EA]"
                hoverColor="hover:border-[#9333EA]/30 group-hover:bg-[#9333EA]"
              />
              <ActivityCard 
                icon={<Camera size={24} />} 
                title="Coin Photo" 
                desc="Un espace décoré pour immortaliser vos moments avec vos tenues de Saint-Valentin et votre partenaire."
                color="text-[#EC4899]"
                hoverColor="hover:border-[#EC4899]/30 group-hover:bg-[#EC4899]"
              />
              <ActivityCard 
                icon={<Ticket size={24} />} 
                title="Grande Tombola" 
                desc="Achetez vos tickets sur place ! De superbes lots sont à gagner lors du tirage au sort."
                color="text-[#9333EA]"
                hoverColor="hover:border-[#9333EA]/30 group-hover:bg-[#9333EA]"
              />
              <ActivityCard 
              ...
              <ActivityCard 
                ...
                desc="Des lots d’accueil pour tous les participants et de belles récompenses pour les vainqueurs !"
                color="text-[#9333EA]"
                hoverColor="hover:border-[#9333EA]/30 group-hover:bg-[#9333EA]"
              />
              <ActivityCard 
                ...
                desc="Des petits goodies exclusifs en vente sur place pour garder un souvenir de cette soirée."
                color="text-[#EC4899]"
                hoverColor="hover:border-[#EC4899]/30 group-hover:bg-[#EC4899]"
              />
        ...
        {activeTab === 'palmares' && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              <h2 className="text-3xl font-[900] uppercase italic text-[#081031] dark:text-white">Résultats <span className="text-[#9333EA]">2025</span></h2>
            ...
            <div className="mt-12 text-center p-8 bg-slate-50 dark:bg-white/5 rounded-[2rem] border border-slate-200 dark:border-white/10 border-dashed transition-colors">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">Rendez-vous à la fin du Promobad pour découvrir le meilleur duo mixte !</p>
            </div>
          </div>
        )}
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
              <div>
                <h2 className="text-3xl font-[900] uppercase italic text-[#081031] dark:text-white mb-2">
                  Best Of <span className="text-[#EC4899]">2025</span>
                </h2>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-[#9333EA] hover:bg-[#081031] dark:hover:bg-white text-white dark:hover:text-[#081031] px-6 py-3 rounded-full text-xs font-black uppercase tracking-widest transition-colors flex items-center justify-center gap-2 shadow-lg"
              >
...
// Carte d'Activité avec gestion dynamique des couleurs
const ActivityCard = ({ icon, title, desc, color, hoverColor }) => (
  <div className={`bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-8 border border-slate-200 dark:border-white/5 shadow-sm hover:shadow-md transition-all group ${hoverColor}`}>
    <div className={`w-14 h-14 bg-white dark:bg-black/50 rounded-2xl flex items-center justify-center mb-6 shadow-sm group-hover:text-white transition-colors ${color}`}>
      {icon}
    </div>
