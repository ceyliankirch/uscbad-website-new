...
// ==========================================
// DONNÉES DE DÉMONSTRATION - GRANDE PLUME
// ==========================================
const galleryImages = [
...
// Palmarès adapté au niveau N2-R5
const palmares2025 = [
  { serie: "Série 1 (N2/N3)", sh: "Alexandre L. (USC)", sd: "Léa P. (VGA)", dh: "Thomas / Hugo (USC)", dd: "Marie / Sarah (Noisiel)", dx: "Alexandre / Léa (USC/VGA)" },
  { serie: "Série 2 (R4/R5)", sh: "Maxime R. (SMASH)", sd: "Julie D. (USC)", dh: "Arthur / Paul (VGA)", dd: "Sophie / Chloé (USC)", dx: "Maxime / Julie (SMASH/USC)" },
];

export default function GrandePlumePage() {
      ...
      <section className="relative w-full h-[80svh] min-h-[600px] flex flex-col justify-center items-center text-center overflow-hidden bg-[#081031]">
        ...
        <div className="relative z-20 px-6 max-w-5xl mx-auto mt-20 flex flex-col items-center">
          ...
          <div className="w-24 h-24 md:w-32 md:h-32 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full flex items-center justify-center p-4 mb-8 shadow-[0_0_30px_rgba(0,101,255,0.3)]">
            <img 
              src="/logo-uscbadminton.png" // REMPLACER PAR LE LOGO DU TOURNOI GRANDE PLUME
              alt="Logo Grande Plume" 
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-sm md:text-base font-bold text-slate-300 mb-10">
            <span className="flex items-center gap-2"><Calendar size={18} className="text-[#0065FF]" /> 1er & 2 Février</span>
            <span className="flex items-center gap-2"><MapPin size={18} className="text-[#0065FF]" /> Gymnase Casalis</span>
            <span className="flex items-center gap-2"><Users size={18} className="text-[#0065FF]" /> Séries N2 à R5</span>
          </div>
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8 md:space-y-12">
            ...
            <div className="bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-8 md:p-12 border border-slate-200 dark:border-white/5 relative overflow-hidden group shadow-sm transition-colors">
              ...
              <div className="relative z-10 max-w-4xl">
                <h3 className="text-2xl md:text-3xl font-[900] uppercase italic text-[#081031] dark:text-white mb-6">
                  Le tournoi <span className="text-[#0065FF]">Élite</span>
                </h3>
                <div className="space-y-4 text-sm md:text-base font-medium text-slate-600 dark:text-slate-300 leading-relaxed">
                  <p>
                    L'US Créteil Badminton est très fier de vous convier à sa compétition phare de l'hiver : <strong>La Grande Plume de Créteil</strong> ! Ce tournoi rassemble les meilleurs compétiteurs de la région pour deux jours de matchs intenses.
                  </p>
                  <p>
                    Avec un niveau relevé (N2 à R5), des matchs accrochés et des spectateurs au rendez-vous, préparez-vous à donner le meilleur de vous-même sur les 7 terrains du Complexe Casalis. Nos bénévoles ont tout préparé pour faire de ce weekend une fête du badminton !
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-8 md:p-10 border border-slate-200 dark:border-white/5 relative overflow-hidden group h-full shadow-sm transition-colors">
                ...
                <p className="text-slate-500 dark:text-slate-400 font-medium mb-6 leading-relaxed relative z-10">
                  Le tournoi est réservé aux joueurs confirmés, classés de <strong className="text-[#081031] dark:text-white">N2 à R5</strong>. Deux tableaux maximum par joueur.
                </p>
              ...
              <div className="bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-8 md:p-10 border border-slate-200 dark:border-white/5 relative overflow-hidden group h-full shadow-sm transition-colors">
                ...
                <ul className="space-y-4 relative z-10">
                  <li className="flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-[#081031] dark:text-white uppercase tracking-wider">Samedi 1er Février</h4>
                  ...
                  <li className="flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-[#081031] dark:text-white uppercase tracking-wider">Dimanche 2 Février</h4>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-4 pr-8 border border-slate-200 dark:border-white/5 shadow-sm transition-colors">
              ...
              <div className="w-full md:w-2/3 py-4">
                <h3 className="text-2xl font-[900] uppercase italic text-[#081031] dark:text-white mb-2">Gymnase Casalis</h3>
                <p className="text-[#0065FF] font-bold mb-4">2 Rue de la Côte d'Or, 94000 Créteil</p>
                <div className="flex flex-wrap gap-4 text-xs font-medium text-slate-600 dark:text-slate-400">
                  ...
                  <span className="flex items-center gap-1"><ChevronRight size={14} className="text-[#0065FF]"/> Grandes Tribunes</span>
                </div>
              </div>
            </div>
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="mt-12 bg-slate-50 dark:bg-[#0f172a] rounded-[2rem] p-8 border border-slate-200 dark:border-white/5 text-center flex flex-col items-center">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-white dark:bg-[#081031] border border-slate-200 dark:border-white/10 text-[#081031] dark:text-white hover:text-[#0065FF] dark:hover:text-[#0065FF] px-8 py-3 rounded-full text-xs font-black uppercase tracking-widest transition-colors flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
              >
